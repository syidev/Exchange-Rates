...
var List = React.createClass({
	...
	render: function () {
		...
		var varvar = this.state.currency.map(function (item) {
			return React.createElement(Currency, { ccy: item.ccy, base_ccy: item.base_ccy, buy: item.buy, sale: item.sale });
		});
...
},{"../services/httpservice":172,"./Currency.jsx":169,"react":167}],171:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
var List = require('./components/List.jsx');

ReactDOM.render(React.createElement(List, null), document.getElementById('currency'));

},{"./components/List.jsx":170,"react":167,"react-dom":29}],172:[function(require,module,exports){
